...
(0, v2_1.setGlobalOptions)({
    region: "europe-west1",
    eventarcOptions: { location: "nam7" },
    secrets: ([exports.EMAIL_USER, exports.EMAIL_PASS])
});
// ====== IMPORTS PRINCIPAUX ======
...
exports.executeCallTask = (0, https_1.onRequest)({
    region: "europe-west1",
    memory: "512MiB",
    // ❌ pas de cpu < 1 si tu veux concurrency > 1
    // ✅ pour rester éco : 1 seule requête par instance
    concurrency: 1,
    timeoutSeconds: 120,
    minInstances: 0, // ou 1 si tu veux zéro cold start
    maxInstances: 5,
    // ✅ Secrets requis pour le handler + authentification Cloud Tasks
    secrets: [exports.TASKS_AUTH_SECRET, twilio_1.TWILIO_ACCOUNT_SID, twilio_1.TWILIO_AUTH_TOKEN, twilio_1.TWILIO_PHONE_NUMBER],
...
exports.stripeWebhook = (0, https_1.onRequest)({
    ...
    secrets: [
        ...
        exports.STRIPE_WEBHOOK_SECRET_TEST,
        exports.STRIPE_WEBHOOK_SECRET_LIVE,
...
// ========================================
exports.testWebhook = (0, https_1.onRequest)(Object.assign(Object.assign({}, emergencyConfig), { timeoutSeconds: 30, secrets: [exports.TASKS_AUTH_SECRET] }), wrapHttpFunction('testWebhook', async (req, res) => {
    try {
