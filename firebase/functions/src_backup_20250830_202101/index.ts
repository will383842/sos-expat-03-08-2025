...
// ====== PARAMS & SECRETS ADDITIONNELS (TEST vs LIVE) ======
...
// Clés Stripe spécifiques TEST/LIVE (en plus du STRIPE_SECRET_KEY générique ci-dessus)
export const STRIPE_SECRET_KEY_TEST = defineSecret('STRIPE_SECRET_KEY_TEST');
export const STRIPE_SECRET_KEY_LIVE = defineSecret('STRIPE_SECRET_KEY_LIVE');

// Webhook secrets Stripe spécifiques TEST/LIVE (en plus du STRIPE_WEBHOOK_SECRET générique)
